    ...
    <Card className="border-violet-500/20 bg-violet-500/5">
      ...
      {text && (
        <div className="mt-3">
          ...
          <Btn variant="ghost" className="mt-2" onClick={() => navigator.clipboard.writeText(text)}><span className="inline-flex items-center gap-1"><Copy size={14} /> Copiar</span></Btn>
        </div>
      )}
    </Card>
  );
